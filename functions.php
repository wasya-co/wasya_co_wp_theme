...
function do_enqueue_scripts() {
  ...
  wp_enqueue_style('style', get_template_directory_uri() . '/assets/css/site.css', array(), wp_get_theme()->get( 'Version' ) );
  wp_enqueue_style('style-nav', get_template_directory_uri() . '/assets/css/site-navigation.css', array(), wp_get_theme()->get( 'Version' ) );
